...
<template>
  <div>
    ...
    <div class="mx-auto">
      ...
      <div v-else>
        <div v-if="orgData?.financially_frozen" class="bg-red-500/10 text-red-400 border-2 border-red-500/50 rounded-lg p-4 mb-6 flex items-center gap-3" >
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-red-400 shrink-0" viewBox="0 0 24 24" fill="currentColor">
